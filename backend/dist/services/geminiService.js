...
exports.auditInvoiceWithGemini = auditInvoiceWithGemini;
...
`;
async function auditInvoiceWithGemini(fileBuffer, mimeType, originalname = "invoice.pdf") {
...
Assign an overall Invoice Risk Score from 0 (Clean) to 100 (Severe Corruption / Massive Price Gouging).`,
            ...
            config: {
                ...
                responseSchema: {
                    ...
                    properties: {
                        invoiceNumber: { type: genai_1.Type.STRING },
                        vendorName: { type: genai_1.Type.STRING },
                        totalAmountKes: { type: genai_1.Type.NUMBER },
                        overallRiskScore: { type: genai_1.Type.NUMBER },
                        riskLevel: {
                            type: genai_1.Type.STRING,
                            enum: ["LOW", "MEDIUM", "HIGH", "CRITICAL"]
                        },
                        summaryNotes: { type: genai_1.Type.STRING },
                        items: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    quantity: { type: genai_1.Type.INTEGER },
                                    invoicedUnitPriceKes: { type: genai_1.Type.NUMBER },
                                    marketUnitPriceKes: { type: genai_1.Type.NUMBER },
                                    inflationPercentage: { type: genai_1.Type.NUMBER },
                                    isFlagged: { type: genai_1.Type.BOOLEAN },
                                    flagReason: { type: genai_1.Type.STRING },
                                    riskLevel: {
                                        type: genai_1.Type.STRING,
                                        enum: ["LOW", "MEDIUM", "HIGH", "CRITICAL"]
                                    },
...
function generateDynamicAuditAnalysis(fileBuffer, originalname) {
