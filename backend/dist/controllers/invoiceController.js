...
exports.getBenchmarks = exports.updateInvoiceStatus = exports.getInvoiceById = exports.getInvoices = exports.uploadAndAuditInvoice = void 0;
const db_1 = require("../config/db");
const geminiService_1 = require("../services/geminiService");
const uploadAndAuditInvoice = async (req, res) => {
    try {
        if (!req.file) {
        ...
        const auditResult = await (0, geminiService_1.auditInvoiceWithGemini)(buffer, mimetype, originalname);
        ...
        const invoice = await db_1.prisma.invoice.create({
            data: {
                ...
                items: {
                    create: (auditResult.items || []).map((item) => ({
...
exports.uploadAndAuditInvoice = uploadAndAuditInvoice;
...
const updateInvoiceStatus = async (req, res) => {
    try {
        ...
        const updated = await db_1.prisma.invoice.update({
            where: { id },
            data: { status },
            include: { items: true },
        });
...
const getBenchmarks = async (_req, res) => {
    try {
        const benchmarks = await db_1.prisma.benchmarkPrice.findMany({
